    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                ...
                <div class="card-header py-4" style="background: linear-gradient(135deg, #8B4513 0%, #A0522D 100%); position: relative;">
                    ...
                    <div class="text-center">
                        ...
                        <h2 class="text-white mb-1" style="font-weight: 800;">¡Crea tu cuenta!</h2>
                        <p class="text-white mb-0" style="opacity: 0.9;">Únete a K-pop Dtb</p>
                    </div>
                </div>
                ...
                <div class="card-body p-5" style="background-color: #f8f9fa;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- Campo Nombre -->
                        <div class="mb-4">
                            <label for="name" class="form-label" style="color: #495057; font-weight: 600;">Nombre y Apellido</label>
                        ...
                        <div class="mb-4">
                            <label for="password-confirm" class="form-label" style="color: #495057; font-weight: 600;">Confirmar Contraseña</label>
                            <div class="input-group">
                                <span class="input-group-text" style="background-color: #fff; border-right: none;">
                                    <i class="fas fa-lock" style="color: #97866A;"></i>
                                </span>
                        ...
                        <div class="text-center pt-3" style="border-top: 1px solid #a35151;">
                            <p class="mb-2" style="color: #a35151;">¿Ya tienes una cuenta?</p>
