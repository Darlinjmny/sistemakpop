            ...
            <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                ...
                <div class="card-header py-4" style="background: #97866A;">
                    <div class="text-center">
                        ...
                        <h2 class="text-white mb-1" style="font-weight: 800;">Editar Álbum</h2>
                        <p class="text-white mb-0" style="opacity: 0.9;">Actualiza la información del álbum</p>
                    </div>
                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-control form-control-lg @error('group_id') is-invalid @enderror" 
                                ...
                                @foreach($groups as $group)
                                    <option value="{{ $group->id }}" {{ $album->group_id == $group->id ? 'selected' : '' }}>
                                        {{ $group->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control form-control-lg @error('release_date') is-invalid @enderror" 
                                       id="release_date" name="release_date" value="{{ old('release_date', $album->release_date) }}" required
                                       style="border-left: none; border-color: #ddd; border-radius: 0 10px 10px 0;">
                            </div>
                            @error('release_date')
                                <div class="text-danger small mt-2">{{ $message }}</div>
