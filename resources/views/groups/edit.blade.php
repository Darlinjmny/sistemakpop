            ...
            <div class="card border-0 shadow-lg overflow-hidden" style="border-radius: 20px;">
                ...
                <div class="card-header py-4" style="background: #97866A;">
                    <div class="text-center">
                        ...
                        <h2 class="text-white mb-1" style="font-weight: 800;">Editar Grupo</h2>
                        <p class="text-white mb-0" style="opacity: 0.9;">Actualiza la información del grupo</p>
                    </div>
                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control form-control-lg @error('debut_date') is-invalid @enderror" 
                                       id="debut_date" name="debut_date" value="{{ old('debut_date', $group->debut_date) }}" required
                                       style="border-left: none; border-color: #ddd; border-radius: 0 10px 10px 0;">
                            </div>
                            @error('debut_date')
                                <div class="text-danger small mt-2">{{ $message }}</div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control form-control-lg @error('company') is-invalid @enderror" 
                                       id="company" name="company" value="{{ old('company', $group->company) }}" required
                                       style="border-left: none; border-color: #ddd; border-radius: 0 10px 10px 0;">
                            </div>
                            @error('company')
                                <div class="text-danger small mt-2">{{ $message }}</div>
